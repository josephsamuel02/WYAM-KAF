  ...
  return (
    <footer
      className={`relative border-t transition-colors duration-300 ${
        isDarkMode ? "border-white/5 bg-secondary-950" : "border-secondary-200 bg-secondary-50"
      }`}
    >
      {/* Background Gradient */}
      <div className="absolute inset-0 -z-10">
        <div
          className={`absolute inset-0 ${
            isDarkMode
              ? "bg-linear-to-b from-secondary-900/50 to-secondary-950"
              : "bg-linear-to-b from-white to-secondary-100"
          }`}
        />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <IoMailOutline className="w-5 h-5 shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
              ...
              <li>
                ...
                >
                  <IoCallOutline className="w-5 h-5 shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
                  <span>+2349067357967, +2348155744455</span>
                </a>
              </li>
              <li>
                <div
                ...
                >
                  <IoLocationOutline className="w-5 h-5 shrink-0 mt-0.5" />
                  <span>
                    No 4 Chawai Street Katsit - Kafanchan, Kaduna State. Nigeria <br /> P. O.
                    Box 175
                  </span>
                </div>
              </li>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p
              className={`text-sm ${isDarkMode ? "text-secondary-400" : "text-secondary-500"}`}
            >
