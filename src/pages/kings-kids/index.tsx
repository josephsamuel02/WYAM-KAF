...
const photos = [
  {
    ...
    description:
      "Leading children into a deeper encounter with God through joyful worship and heartfelt praise.",
  },
  {
    url: "/kings_kids_outreach_1766602611673.png",
    title: "Creative Outreach",
    description:
      "Equipping young people to serve and share God's love in their communities through creative expression.",
  },
  {
    url: "/kings_kids_family_discipleship_1766602636629.png",
    title: "Family Discipleship",
    description:
      "Walking together as families and generations to follow Jesus and build lasting faith foundations.",
  },
];
...
const accordionItems = [
  {
    ...
    title: "Our Vision",
    content:
      "We aim to see every child and teenager discovering their identity in Christ and walking in their God-given purpose. Through worship, discipleship, and creative missions, we foster a generation that is unashamed of the Gospel and passionate about making God known.",
  ...
  },
  {
    ...
    content:
      "We provide opportunities for children and youth to grow in their relationship with God through prayer, Bible study, worship, and discipleship. Our programs are designed to help young people develop a strong foundation of faith that will guide them throughout their lives.",
  ...
  },
  {
    ...
    content:
      "We believe in putting faith into action. Our young people participate in local outreaches, community service projects, and creative missions that demonstrate God's love in practical ways. Through these experiences, they learn to serve others and make a positive impact in their communities.",
  ...
  },
  {
    ...
    content:
      "We celebrate the unique gifts and talents of each child. Through music, dance, drama, and other creative expressions, we help young people discover how they can use their God-given abilities to glorify Him and share His love with others.",
  ...
  },
  {
    ...
    content:
      "We cultivate a heart for the nations by teaching children about God's love for all peoples. Through stories, missions education, and cross-cultural experiences, we help young people understand their role in God's global mission and develop a passion for reaching the world.",
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                We believe children are significant in the present for establishing God's
                kingdom. Our ministry focuses on raising up a generation that knows their
                identity in Christ, walks in their purpose, and impacts their world for
                eternity.
              </p>
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      We focus on heart-level change, not just behavior modification, helping
                      children develop a genuine love for God.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      We create safe spaces where children can build meaningful relationships
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      We help children see beyond themselves and understand their role in God's
                      global mission.
                    </p>
                  </div>
                </div>
